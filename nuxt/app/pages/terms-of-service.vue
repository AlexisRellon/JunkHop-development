<template>
  <div class="flex items-center justify-center py-10 min-h-screen bg-gray-100 dark:bg-gray-900">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
      <div class="font-black text-3xl tracking-tight text-center">
        <span class="text-gray-700 dark:text-gray-100">Terms of</span>
        <span class="text-primary-500"> Service</span>
      </div>

      <section class="mb-8">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-300 mb-4">
          Introduction
        </h2>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <li>
            Any misuse of the platform may result in the suspension or termination of your account.
          </li>
        </ul>
      </section>
