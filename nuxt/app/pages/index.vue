...
<template>
  ...
  <section
    ...
    <div v-if="heroParticlesEnabled" class="absolute inset-0 overflow-hidden pointer-events-none">
      <UIcon v-for="(item, index) in recyclingItems" :key="index" :name="item.icon" :class="[item.color, item.size]"
        :style="item.style" />
    </div>
    ...
    <div class="container relative z-10 px-4 mx-auto grid md:grid-cols-2 gap-12 items-center py-12">
      ...
      <div class="text-left" data-aos="fade-right" data-aos-duration="1000">
        ...
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
          Make <span class="text-teal-300 inline-block relative">recycling<span
              class="absolute -bottom-1 left-0 w-full h-1 bg-teal-300/50"></span></span>
          <span class="block">part of your daily life</span>
        </h1>

        <p class="text-lg md:text-xl text-gray-200 mb-8 max-w-lg">
          Connect with local junk shops, track your environmental impact, and join a community committed to
          sustainability.
        </p>

        <div class="flex flex-wrap gap-4 mb-12">
          <UButton label="Get Started" @click="router.push('/auth/register')" color="white" variant="solid" size="xl"
            class="font-medium" icon="i-heroicons-arrow-right" trailing />
          <UButton label="How It Works" @click="scrollToDetails" color="white" variant="outline" size="xl"
      ...
      <div class="relative hidden md:block" data-aos="fade-left" data-aos-duration="1000">
        <div class="relative">
          ...
          <div
            class="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl flex items-center gap-3 animate-pulse">
            <UIcon name="i-heroicons-check-circle" class="text-teal-500" size="24" />
            <span class="font-medium">Verified Shops</span>
          </div>

          <div
            class="absolute -top-6 -right-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xl flex items-center gap-3 animate-pulse delay-300">
    ...
    <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
      <UButton icon="i-heroicons-chevron-down" color="white" variant="ghost" @click="scrollToDetails"
  ...
  <section id="details-section" class="py-24 bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
    ...
    <div
      class="absolute top-0 left-0 w-64 h-64 bg-teal-100 dark:bg-teal-900/30 rounded-full -translate-y-1/2 -translate-x-1/3 blur-3xl opacity-70">
    </div>
    ...
    <div class="container px-4 mx-auto relative">
      <div class="max-w-3xl mx-auto text-center mb-16" data-aos="fade-up">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
          JunkHop connects residents with local junk shops, making recycling more accessible and organized while
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <UCard data-aos="fade-up" data-aos-delay="100"
          ...
          <div class="text-center p-6">
            ...
            <p class="text-gray-600 dark:text-gray-300">Discover verified junk shops in your vicinity with detailed
              information
              about accepted materials</p>
          </div>
          <template #footer>
            <UButton color="teal" variant="ghost" block label="Explore Map" icon="i-heroicons-arrow-right" trailing
              to="/finder" />
          </template>
        </UCard>

        <UCard data-aos="fade-up" data-aos-delay="300"
          class="hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-800">
          <template #header>
            <div class="flex justify-center p-6 bg-teal-50 dark:bg-teal-900/30">
          ...
          <div class="text-center p-6">
            ...
            <p class="text-gray-600 dark:text-gray-300">Manage your account, track your recycling history, and monitor
              your
              environmental impact</p>
          </div>
          <template #footer>
            <UButton color="teal" variant="ghost" block label="Get Started" icon="i-heroicons-arrow-right" trailing
              @click="auth.logged ? router.push('/account') : router.push('/auth/register')" />
          </template>
        </UCard>

        <UCard data-aos="fade-up" data-aos-delay="500"
          class="hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100 dark:border-gray-800">
          <template #header>
            <div class="flex justify-center p-6 bg-teal-50 dark:bg-teal-900/30">
          ...
          <div class="text-center p-6">
            ...
            <p class="text-gray-600 dark:text-gray-300">For shop owners to manage their business profile, accepted
              materials,
              and connect with customers</p>
          </div>
          <template #footer>
            <UButton color="teal" variant="ghost" block label="Register Shop" icon="i-heroicons-arrow-right" trailing
              to="/dashboard" />
          </template>
        </UCard>
      </div>
      ...
      <div class="mt-20 max-w-3xl mx-auto text-center" data-aos="fade-up" data-aos-delay="300">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          Our platform bridges the gap between community members and local junk shops, promoting sustainable waste
          management
  ...
  <section id="key-features"
    class="py-24 bg-gradient-to-br from-white to-teal-50 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
    <!-- Background decoration -->
    <div
      class="absolute top-0 right-0 w-64 h-64 bg-teal-100 dark:bg-teal-900/30 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl opacity-70">
    </div>
    <div
      class="absolute bottom-0 left-0 w-96 h-96 bg-teal-100 dark:bg-teal-900/30 rounded-full translate-y-1/3 -translate-x-1/3 blur-3xl opacity-70">
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <UCard data-aos="zoom-in"
          ...
          <div class="p-6 flex flex-col h-full">
            <div
              class="rounded-full bg-teal-100 dark:bg-teal-900/50 w-16 h-16 flex items-center justify-center mb-6 group-hover:bg-teal-200 dark:group-hover:bg-teal-800 transition-colors duration-300">
            ...
            <p class="text-gray-600 dark:text-gray-300 mb-4 flex-grow">
              Find verified junk shops near you with our map-based interface. Filter by materials accepted, operating
        ...
        <div class="md:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <!-- Profile Management -->
          <UCard data-aos="zoom-in" data-aos-delay="100"
          ...
          <UCard data-aos="zoom-in" data-aos-delay="200"
            class="border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
            <div class="p-6">
              <div
                class="rounded-full bg-amber-100 dark:bg-amber-900/30 w-12 h-12 flex items-center justify-center mb-4">
          ...
          <!-- Notifications -->
          <UCard data-aos="zoom-in" data-aos-delay="300"
            class="border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
            <div class="p-6">
              <div
                class="rounded-full bg-purple-100 dark:bg-purple-900/30 w-12 h-12 flex items-center justify-center mb-4">
          ...
          <!-- Community Features -->
          <UCard data-aos="zoom-in" data-aos-delay="400"
            class="border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
            <div class="p-6">
              <div
                class="rounded-full bg-green-100 dark:bg-green-900/30 w-12 h-12 flex items-center justify-center mb-4">
  ...
  <section id="how-it-works" class="py-24 bg-gray-50 dark:bg-gray-900 relative">
    <div class="container px-4 mx-auto">
      ...
      <div class="relative">
        ...
        <div
          class="hidden md:block absolute top-[37%] left-0 right-0 h-1 bg-teal-200 dark:bg-teal-800 transform -translate-y-1/2 z-0">
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8 relative z-10">
          ...
          <div class="flex flex-col items-center text-center" data-aos="fade-right" data-aos-delay="100">
            <div
              class="w-20 h-20 rounded-full flex items-center justify-center bg-white dark:bg-gray-800 border-4 border-teal-400 dark:border-teal-600 mb-6 shadow-lg relative">
              <span
                class="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center text-sm font-bold">1</span>
            ...
            <UButton color="teal" variant="ghost" label="Register Now" class="mt-6" size="sm" to="/auth/register"
          ...
          <div class="flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="300">
            <div
              class="w-20 h-20 rounded-full flex items-center justify-center bg-white dark:bg-gray-800 border-4 border-teal-400 dark:border-teal-600 mb-6 shadow-lg relative">
              <span
                class="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center text-sm font-bold">2</span>
            ...
            <UButton color="teal" variant="ghost" label="Explore Map" class="mt-6" size="sm"
              icon="i-heroicons-arrow-right" trailing />
          </div>
          ...
          <div class="flex flex-col items-center text-center" data-aos="fade-left" data-aos-delay="500">
            <div
              class="w-20 h-20 rounded-full flex items-center justify-center bg-white dark:bg-gray-800 border-4 border-teal-400 dark:border-teal-600 mb-6 shadow-lg relative">
              <span
                class="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-teal-500 text-white flex items-center justify-center text-sm font-bold">3</span>
            ...
            <UButton color="teal" variant="ghost" label="View Dashboard" class="mt-6" size="sm"
              icon="i-heroicons-arrow-right" trailing />
          </div>
        </div>
      </div>
  ...
  <section id="community-impact" class="py-24 bg-white dark:bg-gray-800 overflow-hidden relative">
    ...
    <div class="absolute inset-0 opacity-10">
      <div class="absolute top-0 left-0 w-full h-full bg-repeat"
        style="background-image: url('data:image/svg+xml,%3Csvg width=\'20\' height=\'20\' viewBox=\'0 0 20 20\' fill=\'none\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'10\' cy=\'10\' r=\'1\' fill=\'%2310B981\'/%3E%3C/svg%3E%0A');">
      </div>
    </div>
    ...
    <div class="container px-4 mx-auto relative">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <!-- Waste Collected -->
        <div
          class="bg-gradient-to-br from-teal-50 to-teal-100 dark:from-gray-700 dark:to-teal-900/30 p-8 rounded-2xl shadow-sm text-center transform transition-all duration-500 hover:scale-105"
          ...
          <div
            class="text-5xl font-extrabold text-teal-600 dark:text-teal-400 mb-2 flex items-center justify-center gap-2"
        ...
        <div
          ...
          <div class="text-5xl font-extrabold text-teal-600 dark:text-teal-400 mb-2 flex items-center justify-center"
      ...
      <div class="mt-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="(testimonial, index) in testimonials" :key="index"
            ...
            :data-aos="index % 2 === 0 ? 'fade-right' : 'fade-left'" :data-aos-delay="index * 200">
  ...
  <section id="join-movement"
    class="py-20 bg-gradient-to-br from-teal-600 to-teal-700 dark:from-teal-800 dark:to-teal-900 text-white relative overflow-hidden">
    <!-- Background elements -->
    ...
    <div class="container px-4 mx-auto relative">
      <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
        ...
        <p class="text-xl mb-10 text-teal-100">
          Be part of the solution. Together, we can make recycling easier, more effective, and create a cleaner planet
          for
          future generations.
        </p>

        <div class="flex flex-wrap justify-center gap-6 mb-12">
          <UButton label="Sign Up Now" to="/auth/register" color="white" variant="solid" size="xl"
            class="text-teal-700 font-medium" icon="i-heroicons-arrow-right" trailing data-aos="zoom-in"
            data-aos-delay="200" />
          <UButton label="Learn More" to="/about" color="white" variant="outline" size="xl" class="font-medium"
        ...
        <div class="mt-12" data-aos="fade-up" data-aos-delay="600">
          ...
          <div class="flex justify-center gap-6">
            <UButton icon="i-simple-icons-facebook" color="white" variant="ghost" class="rounded-full hover:bg-white/10"
              aria-label="Facebook" />
            <UButton icon="i-simple-icons-twitter" color="white" variant="ghost" class="rounded-full hover:bg-white/10"
              aria-label="Twitter" />
            <UButton icon="i-simple-icons-instagram" color="white" variant="ghost"
              class="rounded-full hover:bg-white/10" aria-label="Instagram" />
            <UButton icon="i-simple-icons-linkedin" color="white" variant="ghost" class="rounded-full hover:bg-white/10"
              aria-label="LinkedIn" />
          </div>
        </div>
      </div>
...
@keyframes floating {
  0% {
    transform: translateY(0) rotate(0deg) translateX(85px);
  }

  50% {
    transform: translateY(-10px) rotate(-2deg) translateX(85px);
  }
