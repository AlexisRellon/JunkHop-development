...
namespace Illuminate\Support\Facades {
     ...
     */        class Request {
         ...
         * 
         *
         * @see \Reefki\DeviceDetector\DeviceDetectorServiceProvider::boot()
         * @static 
         */        public static function device()
        {
                        return \Illuminate\Http\Request::device();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\Request::deviceName();
        }
            }
            /**
     * 
...
namespace Reefki\DeviceDetector {
     ...
     */        class Device {
         ...
         * @static 
         */        public static function detect($userAgent, $headers = [])
        {
                        /** @var \Reefki\DeviceDetector\DeviceDetector $instance */
                        return $instance->detect($userAgent, $headers);
        }
                    /**
         ...
         * @return \DeviceDetector\DeviceDetector 
         * @static 
         */        public static function detectRequest($request)
        {
                        /** @var \Reefki\DeviceDetector\DeviceDetector $instance */
                        return $instance->detectRequest($request);
        }
            }
    }
...
namespace Illuminate\Support {
     ...
     */        class Str {
         ...
         * @return string 
         * @static 
         */        public static function onlyWords($text)
        {
                        return \Illuminate\Support\Str::onlyWords($text);
        }
            }
    }
...
namespace Illuminate\Http {
     ...
     */        class UploadedFile {
         ...
         * @param int $quality
         * @static 
         */        public static function convert($width = null, $height = null, $extension = 'webp', $quality = 90)
        {
                        return \Illuminate\Http\UploadedFile::convert($width, $height, $extension, $quality);
        }
            }
    }
...
namespace  {
            ...
            class Device extends \Reefki\DeviceDetector\Device {}
